	...
	<div class="tab-con guid-bd">
			<dl>
				...
				<dl>
					...
					<dd>
						   套餐购买成功后，即可获得10元红包奖励，具体使用规则如下：
					</dd>
					<dd>
						 A、【参与对象】活动期间，通过本活动页面进来的你我金融首次借款用户（你我金融与和彩云的注册手机号需一致）
					</dd>
					<dd>
						 B、【如何领奖】用户成功借款后，在其按时偿还首期款后的7个工作日之内，10元现金红包将发放至用户的你我金融账号上，请下载“你我金融”APP并在“我-财富中心”中查看
					</dd>
					<dd>
						 C、【奖励规则】每个注册号码只可获得1次赠送
					</dd>
					<dd>
					 	 D、【勾搭客服】有问题请咨询你我金融客服专线：400-0683-666或致电10086
					</dd>
				</dl>
		</div>
</section>
