...
function getHerf(){
	if (<%=phone%> == null) {
		...
		window.location.href='http://link.weibo.10086.cn:18081/yunpay/pay/tosure?tcId=7&lx=1&phone=<%=phone%>&name=和彩云100GB空间月包&space=100GB&price=8&flag=WEB&sin=kdyzy&openId=&channel=';
	}
}
</script>
</head>
